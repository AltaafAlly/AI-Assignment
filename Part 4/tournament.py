...
results_file = f"Troutbot_VS_RandomSensing_{timestamp}.txt"

# Run the round-robin tournament
with open(results_file, "w") as file:
    white_bot, white_bot_path = ("TroutBot", trout_bot_path)
    black_bot, black_bot_path = ("RandomSensing", random_sensing_path)
